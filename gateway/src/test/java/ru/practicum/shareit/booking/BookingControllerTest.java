...
public class BookingControllerTest {
    ...
    public void addBooking() throws Exception {
        ...
        when(client.add(any(), any())).thenReturn(new ResponseEntity<>(bookingDto, HttpStatus.OK));
    ...
    public void makeApprove() throws Exception {
        ...
        when(client.makeApprove(any(), any(), anyBoolean()))
    ...
    public void getById() throws Exception {
        BookingDto bookingDto = new BookingDto(1L, getLTD("+", 2), getLTD("+", 3),
                null, 1L, null, 1L, BookingStatus.WAITING);
        when(client.getById(any(), any())).thenReturn(new ResponseEntity<>(bookingDto, HttpStatus.OK));
    ...
    public void getByUserAndState() throws Exception {
        BookingDto bookingDto = new BookingDto(1L, getLTD("+", 2), getLTD("+", 3),
                null, 1L, null, 1L, BookingStatus.WAITING);
        when(client.getByUserAndState(any(), any(), any(), any()))
                .thenReturn(new ResponseEntity<>(List.of(bookingDto), HttpStatus.OK));
    ...
    public void getByOwnerAndState() throws Exception {
        BookingDto bookingDto = new BookingDto(1L, getLTD("+", 2), getLTD("+", 3),
                null, 1L, null, 1L, BookingStatus.WAITING);
        when(client.getByOwnerAndState(any(), any(), any(), any()))
                .thenReturn(new ResponseEntity<>(List.of(bookingDto), HttpStatus.OK));
